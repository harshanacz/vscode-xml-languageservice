...
export interface IXMLDataProvider {
	getId(): string;
...
export interface LanguageServiceOptions {
	/**
	 * Unless set to false, the default XML data provider will be used 
	 ...
	 * XML tag / attribute / attribute-value
	 */
	customDataProviders?: IXMLDataProvider[];

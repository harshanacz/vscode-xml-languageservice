import { createScanner } from './xmlScanner.js';
import { findFirst } from '../utils/arrays.js';
import { TokenType, TextDocument, Node as XMLNode, XMLDocument } from '../xmlLanguageTypes.js';

import { XMLDataManager } from '../languageFacts/xmlDataManager.js';

export class Node implements XMLNode {
...
export class XMLParser {
	constructor(private dataManager: XMLDataManager) {
	}
		...
		while (token !== TokenType.EOS) {
			switch (token) {
				...
				case TokenType.AttributeName: {
					...
					attributes[pendingAttribute] = null; // Support valueless attributes
					break;
				}
